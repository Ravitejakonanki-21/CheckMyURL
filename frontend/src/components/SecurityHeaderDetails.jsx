...
function ClipboardButton({ value, copied, onCopy }) {
  return (
    <button
      onClick={onCopy}
      className="absolute top-3 right-3 text-[#00e5ff] hover:text-[#00ccf0] transition"
    ...
    <div className="relative w-full px-3 sm:px-6">
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        ...
        <div className="w-full md:w-1/2">
          <h4 className="text-lg font-semibold mb-2 mt-3 text-[#00e5ff]">
                ...
                >
                  ...
                  <div className="flex items-center mb-1">
                    ...
                    <a
                      ...
                      className="ml-2 text-[#00e5ff] underline text-xs"
                      tabIndex={-1}
                    >
                      docs
                    </a>
        ...
        <div className="w-full md:w-1/2">
          <h4 className="text-lg font-semibold mb-2 mt-3 text-[#00e5ff]">Advanced Technical Details</h4>
              ...
              Object.entries(all_headers).map(([header, value], idx, arr) => (
                <React.Fragment key={header}>
                  ...
                  >
                    ...
                    />
                    <div className="font-mono text-xs text-[#00e5ff]/80 mb-1 uppercase tracking-wide">{header}</div>
                  ...
                  {idx === arr.length - 1 && onHide && (
                    <div className="col-span-full flex justify-end">
                      <button
                        onClick={onHide}
                        className="mt-2 mb-2 px-4 py-2 bg-transparent border border-[#00e5ff]/40 text-[#00e5ff] rounded-md font-semibold text-base hover:bg-[#00e5ff]/10 hover:text-white shadow transition-colors duration-200"
                      >
